...
<html lang="es">
    <head>
    	<title>ConsultaMedica_Directorio</title>
        ...
        <link rel="stylesheet" type="text/css" href="../css/hint_CSS/hint.css">
        ...
        <h3 class="encabezadoSesion_1">Directorio Médico</h3>        
            <section>  
                <div>  
                    ...
                    <nav id="Menu" style="text-align: center; width: 95%; margin: auto; "><!--alfabeto del directorio-->
                    ...
                    <div id="Directorio_00" style="background-color: ;">
                        <a name="marcadorA" ></a>
