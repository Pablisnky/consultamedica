...
<html lang="es">
    ...
    <body onload="llamar_todosMedicamentoSolicitado(); mostrarLupa_2();"><!--mostrarLupa_2() esta al final de este archivo-->
        <?php   
        ...
        <div style="min-height: 85%;">
            ...
            <div class="ocultarMenu" onclick="ocultarMenu()"><!-- contenedor se hace click y se oculta el menu responsive; ocultarMenu() se encuentra en Funciones_varias.js-->                      
                ...
                <div class="medicinas_2">
                    <p class="Inicio_1">Si usted requiere un medicamento no disponible en el mercado, puede publicar en nuestra plataforma las especificaciones del mismo, otro usuario pudiese atender su solicitud</p> 
                </div>
                <div id="Perfil_05_B">
                    <div id="Perfil_07">
                        <a style='margin: auto; display: block; margin: auto;' href='cargar_Solicitud.php' class='buttonCuatro'>Solicitar</a>
                    </div>
               </div>
                <form>
                    <input type="text" id="MarcaParaAjax" value="MarcaParaAjax" hidden><!--marca para enviar a Ajax-->
                </form>                
                <div id="Lupa_2" onclick="mostrarMedicinasSolicitadas()" style="background-color: ; width: 100%; display: none;">
