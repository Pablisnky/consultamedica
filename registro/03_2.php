    ...
    //Perfiles de Dr.
        ...
        $Doctor=$_GET["ID_Doctor"];//Recibe el ID_Doctor desde directorio.php
        //echo "ID_Doctor= " . $Doctor . "<br>";    
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////  -->
    ...
    <div  class="Principal_2" onclick="ocultarMenu()"><!--en este contenedor se hace click y se oculta el menu responsive-->   
        <form method="POST" action="Citas_2Autofill_2.php" name="consulta">
            <div class="encabezado_03">
                <?php 
                $consulta_1="SELECT ID_Doctor,nombre_doctor,apellido_doctor, especialidad, sexo, fotografia FROM doctores INNER JOIN especialidades ON doctores.ID_Especialidad=especialidades.ID_Especialidad WHERE ID_Doctor= '$Doctor' ";
                ...
                while($Doctor_Datos= mysqli_fetch_array($Recorset_1)){
                    ...
                    <input  type="text" hidden name="codigoDoctor" id="Doctor" value="<?php echo $Doctor_Datos['ID_Doctor'];?>">
...
<!-- Ubicación -->
            ...
            <div class="contenedor_03"> 
                <div id="Perfil_01"><!--HTML sin cortar el codigo PHP, otra manera de combinar ambos codigos-->
                    <?php
                    $Consulta_2="SELECT ID_Doctor,estado,ciudad FROM doctores WHERE ID_Doctor= '$Doctor' ";
...
<!-- Telefonos -->
                ...
                <div id="Perfil_01"><!--HTML sin cortar el codigo PHP, otra manera de combinar ambos codigos-->
                    <?php
                    $Consulta_2="SELECT telefono_consultorio, telefono_movil FROM doctores WHERE ID_Doctor= '$Doctor' ";
                    ...
                    ?>
                        ...
                        <div class="telefonos_03">
                            <div class="telefono_03A">
                                <label class="A_05A">Celular:</label>
                                <input class="A_05" type="text" name="telefono_movil" readonly="readonly" value="<?php echo $Telefono['telefono_movil'];?>">
                            </div>
                            <div class="telefono_03B">
                                <label class="A_05A">Consultorio:</label>
                                <input class="A_05" type="text" name="telefono_consultorio" readonly="readonly" value="<?php echo $Telefono['telefono_consultorio'];?>">
                            </div>
                        </div>
                   ...
                   mysqli_free_result($Recordset_2); // Liberamos los registros        
                    ?>
                    <br>
                </div><br class="saltoLinea"><br class="saltoLinea"><br class="saltoLinea"><br class="saltoLinea"><br class="saltoLinea">
...
<!-- Costo de la consulta-->
                ...
                <div id="Perfil_01B">
                        <?php
                        $Consulta_3="SELECT precio_consulta, sexo FROM doctores WHERE ID_Doctor= '$Doctor' ";
...
<!--Centro médico-->
                ...
                <div id="Perfil_01A">
                        <?php
                            $Consulta_4="SELECT clinica, direccion, consultorio FROM direcciones WHERE ID_Doctor ='$Doctor'";
                    ...
                    <p class="Inicio_2">Centro médico</p>  
                        ...
                        ?> 
                            ...
                            <input style="background-color: #F4FCFB; margin-top: 6%; border:none ; width: 100%; font-size: 14px; text-align: center;>  type="text" readonly="readonly" name="consultorio" value="<?php echo "Consultorio " . $DirConsulta['consultorio'];?>">     
                        <?php } 
...
<!-- Horarios de consulta -->
                ...
                <div id="Perfil_04"> 
                    <?php
                        $Consulta_5="SELECT * FROM horarios WHERE ID_Doctor = '$Doctor' ";
...
<!-- Perfil profesional -->
            ...
            <div id="Perfil_2">
                ...
                <?php
                            $Consulta_6="SELECT * FROM perfil_doctor WHERE ID_Doctor = '$Doctor' ";
