function SeleccionarParroquia_Nac(form){
    
    var Estado = form.estadoNacimiento.options;//se captura el elemento select que contiene los estados en cargarPaciente_Basico.php
    var Municipio = form.municipioNacimiento.options;//se captura el elemento select que contiene los municipios en cargarPaciente_Basico.php
    var Parroquia = form.parroquiaNacimiento.options;//se captura el elemento select que contiene las parroquias en cargarPaciente_Basico.php
...
// ----------------------------------------------------------------------------------------------------------------------
    ...
    if(Estado[13].selected == true){//Lara
        ...
        if(Municipio[3].selected == true){ //Morán
            Parroquia[0] = new Option("");
        ...
        if(Municipio[7].selected == true){//Urdaneta
            Parroquia[0] = new Option("");
        ...
        if(Municipio[8].selected == true){//Iribarren
            Parroquia[0] = new Option("");
        ...
        if(Municipio[9].selected == true){//Jiménez
            Parroquia[0] = new Option("");
