...
<?php
    ...
    $Nombre= $_GET["principio"];//se recibe lo que se escribio en el input desde ajaxBuscador.js
    ...
    if(!empty($Nombre)){ 
    	...
    	$Consulta=  "SELECT * FROM  medicamentos_ofrecidos INNER JOIN medicamentofrecido_proveedor ON medicamentos_ofrecidos.ID_Proveedor=medicamentofrecido_proveedor.ID_Proveedor  WHERE principio_Activo LIKE '$Persona%' ORDER BY principio_Activo ASC";
