            ...
            <div style="background-color:; width: 65%; float: right; margin-right: 4%;  position: relative; margin-top: 1.6%;">
                <form action="cargarNuevaHistoria.php" method="POST">
                    <fieldset class="historia_2" >
                        ...
                        <a name="marcadorMotivoConsulta" class="ancla"></a>
                        <label style="background-color: ; margin-bottom: 1%; margin-top: 4%;" class="">Motivo de consulta 
                            <textarea rows="3" cols="81" name="motivoConsulta"  id="MotivoConsulta">
                            </textarea><br>
                        </label>
                        <br>
                        <a name="marcadorEnfermedadActual" class="ancla"></a>
                        <label style="background-color: ; margin-bottom: 1%; margin-top: 3%;" class="">Enfermedad actual
                            <textarea rows="3" cols="81" name="enfermedadActual"  id="EnfermedadActual">
                            </textarea>
                        </label>
                        <br>
                        <a name="marcadorExamenFuncional" class="ancla"></a>
                        <label style="background-color: ; margin-bottom: 1%; margin-top: 3%;">Examen funcional
                            <textarea rows="3" cols="81" name="examenFuncional" id="ExamenFuncional">
                            </textarea>
                        </label>
                        <br>
                        ...
                        <label style="background-color: ">Examen fisico
                            <div style="background-color: ; margin-left: 5%;">
                                ...
                                <a name="marcadorPiel" class="ancla"></a>
                                <label style="background-color: ; width: 20%; display: block;  margin-bottom: 1%; margin-top: 3%;">Piel</label>
                                <textarea rows="3" cols="76" name="piel"    id="Piel">
                                </textarea>
                                
                                <a name="marcadorCabeza" class="ancla"></a>
                                <label style="background-color: ; font-weight: bolder; font-size: 16px; margin-left: -6%; margin-bottom: 1%; margin-top: 3%; width: 20%; display: block;">Cabeza</label>
                                <div style="background-color: ; width: 100%; height: 50%;">
                                    <div style="border-bottom-style: solid; border-bottom-width: 0.5px; border-color:rgba(4,6,82,0.4); " >
                                        <label style="background-color: ;font-size: 14px;margin-left: -3%; margin-right: -9%; width: 20%; display: inline-block;">Forma</label>
                                    ...
                                    <div style="background-color: ; width: 100%; height: 50%; margin-top: 2%; border-bottom-style: solid; border-bottom-width: 0.5px; border-color:rgba(4,6,82,0.4); ">
                                        <label style="background-color: ;font-size: 14px;margin-left: -3%; margin-right: -9%; width: 20%; display: inline-block; position: relative; top: -13px;">Tamaño</label>
                                    ...
                                    <label style="background-color: ; color: ; font-size: 14px;margin-left: -3%; margin-right: -9%; width: 20%; display: inline-block;">Observaciones</label>
                                ...
                                <a name="marcadorOjos" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Ojos</label>
                                <textarea rows="3" cols="76" name="ojos"    id="Ojos">
                                </textarea>
                                ...
                                <a name="marcadorOidos" class="ancla"></a>       
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Oidos</label>
                                <textarea rows="3" cols="76" name="oidos"    id="Oidos">
                                </textarea>

                                <a name="marcadorNariz" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Nariz</label>
                                <textarea rows="3" cols="76" name="nariz"    id="Nariz">
                                </textarea>
                               
                                <a name="marcadorBoca" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Boca</label>
                                <textarea rows="3" cols="76" name="boca"    id="Boca">
                                </textarea>
                                
                                <a name="marcadorFaringe" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Faringe</label>
                                <textarea rows="3" cols="76" name="faringe"    id="Faringe">
                                </textarea>
                              
                                <a name="marcadorCuello" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Cuello</label>
                                <textarea rows="3" cols="76" name="cuello"    id="Cuello">
                                </textarea>
 
                                <a name="marcadorGangliosLinfaticos" class="ancla"></a>
                                <label style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Ganglios linfaticos</label>
                                <textarea rows="3" cols="76" name="ganglios"    id="Ganglios">
                                </textarea>

                                <a name="marcadorTorax" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Torax</label>
                                <textarea rows="3" cols="76" name="torax"    id="Torax">
                                </textarea>
                                
                                <a name="marcadorMamas" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Mamas</label>
                                <textarea rows="3" cols="76"   name="mamas"         id="Mamas">
                                </textarea>

                                <a name="marcadorRespiratorio" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Respiratorio</label>
                                <textarea rows="3" cols="76" name="respiratorio"    id="Respiratorio">
                                </textarea>

                                <a name="marcadorCardiovascular" class="ancla"></a>
                                <label style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Cardiovascular</label>
                                <textarea rows="3" cols="76" name="cardiovascular"    id="Cardiovascular">
                                </textarea>
                                
                                <a name="marcadorPulso" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Pulso</label>
                                <textarea rows="3" cols="76" name="pulso"    id="Pulso">
                                </textarea>

                                <a name="marcadorAbdomen" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Abdomen</label>
                                <textarea rows="3" cols="76" name="abdomen"    id="Abdomen">
                                </textarea>

                                <a name="marcadorGenitales" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Genitales</label>
                                <textarea rows="3" cols="76" name="genitales"    id="Genitales">
                                </textarea>

                                <a name="marcadorOsteoarticular" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Osteoarticular</label>
                                <textarea rows="3" cols="76" name="osteoarticular"    id="Osteoarticular">
                                </textarea>

                                <a name="marcadorExtremidades" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Extremidades</label>
                                <textarea rows="3" cols="76" name="extremidades"    id="Extremidades">
                                </textarea>

                                <a name="marcadorNeurologico" class="ancla"></a>
                                <label class="" style="background-color: ; width: 20%; display: block; margin-bottom: 1%; margin-top: 3%;">Neurológico</label>
                                <textarea rows="3" cols="76" name="neurológico"    id="Neurológico">
                                </textarea>
